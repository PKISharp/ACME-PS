...
Write-Information "Copying assets"
Copy-Item -Path "$ModuleSourcePath/ACME-PS.png" -Destination "$ModuleOutPath/" -Force;
Copy-Item -Path "$ModuleSourcePath/../LICENSE" -Destination "$ModuleOutPath/" -Force;
